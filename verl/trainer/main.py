...
# from verl.trainer.modif_ray_trainer import RayPPOTrainer, ResourcePoolManager, Role
...
def main_task(config: PPOConfig):
    ...
    trainer = RayPPOTrainer(
        ...
        reward_fn=reward_fn_dict,
        val_reward_fn=val_reward_fn,
    )
    print("RayPPOTrainer init done")
    trainer.init_workers()
    print("trainer.init_workers done")
    trainer.fit()
