...
OUTPUT_DIR=/fs-computility/ai4chem/shared/r1_ckpt/full-op-29
...
python -m verl.trainer.main \
    config=examples/0429/fullsets.yaml \
    data.system_prompt="${SYSTEM_PROMPT}" \
    data.max_prompt_length=8192 \
    worker.actor.model.model_path=${MODEL_PATH} \
    worker.rollout.enable_chunked_prefill=false \
    trainer.experiment_name=qwen2_5_vl_7b_dsw-bs16-16-4-4-full-op-29 \
    2>&1 | tee -a "${OUTPUT_DIR}/training_log_0429full-op.txt" 
