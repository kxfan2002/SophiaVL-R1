...
OUTPUT_DIR=/fs-computility/ai4chem/shared/r1_ckpt/full-op
...
python -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_dsw-bs16-16-4-4-full-op \
    2>&1 | tee -a "${OUTPUT_DIR}/training_log_0424full.txt" 
